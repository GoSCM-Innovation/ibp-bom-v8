...
// Para templates OBSOLETE (JobTemplateRead falla), se usa este mapa estático.
// Labels confirmados desde la API (JobTemplateRead en templates vigentes).
const PARAM_LABEL = {
  ...
  S_MATNR:   'Product',
  S_SUBN:    'Subnetwork',
  // Copy / Delete operators (/IBP/OP_COPYVS, /IBP/OP_DELVS, /IBP/OP_DISAGG)
  P_ACT:     'Operation',
  ...
  S_MD:      'Master Data',
  S_RCODE:   'Reason Code',
  // Statistical Forecasting (/IBP/OP_FCST)
  ...
  // S&OP Operator (/IBP/OP_SCM)
  P_SCMTP:   'S&OP Time Profile Level',
  S_PL_UNT:  'Subnetwork',
  S_SIMUL:   'Scenario',
  S_VERS:    'Version',
  // Data Integration (/IBP/HCI_DI)
  P_AGTGP:   'Agent Group',
  P_AGTNM:   'Agent Name',
  ...
  // Attributes / values (OP_DISAGG, OP_FCST)
  P_ATTR1:   'Attribute 1',
  P_ATTR2:   'Attribute 2',
  P_ATTR3:   'Attribute 3',
