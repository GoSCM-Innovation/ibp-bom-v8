  ...
  return (
    <div style={{
      ...
      <div style={{ padding: '0 16px 16px', flex: 1, overflowY: 'auto' }}>
        {loading && (
          <div style={{ color: 'var(--text2)', fontSize: 12 }}>Procesando…</div>
        )}
        {error && (
          <div style={{
        ...
        {result && (
          <>
            <div style={{ fontSize: 10, color: 'var(--text2)', marginBottom: 6, textTransform: 'uppercase', letterSpacing: '0.05em' }}>
              {resultLabel}
            </div>
            <pre style={{
              background: 'var(--bg)', borderRadius: 6, padding: 12, fontSize: 10,
